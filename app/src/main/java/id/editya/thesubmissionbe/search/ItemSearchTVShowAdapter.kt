...
class ItemSearchTVShowAdapter(private val context: Context, list: ArrayList<ModelTVShow>) :
    RecyclerView.Adapter<ItemSearchTVShowAdapter.CardViewHolder>() {

    var arrList: ArrayList<ModelTVShow> = list

    var sizeSearchTVShow = 0
