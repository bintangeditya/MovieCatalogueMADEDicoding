...
class ItemFavMovieAdapter(private val context: Context, list: ArrayList<ModelMovie>,private val fragment : FavMovieFragment) :
    RecyclerView.Adapter<ItemFavMovieAdapter.CardViewHolder>() {
