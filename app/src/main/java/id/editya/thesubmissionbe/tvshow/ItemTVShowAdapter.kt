...
class ItemTVShowAdapter(private val context: Context, list: ArrayList<ModelTVShow>) :
    RecyclerView.Adapter<ItemTVShowAdapter.CardViewHolder>() {
    ...
    override fun onBindViewHolder(p0: CardViewHolder, p1: Int) {
        ...
        p0.tvTitle.text = arrList[p1].Name
        p0.tvYear.text = arrList[p1].FirstAirDate.substring(0, 4)
